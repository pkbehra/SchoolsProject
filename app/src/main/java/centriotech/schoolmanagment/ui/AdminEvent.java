...
public class AdminEvent extends Fragment {
    ...
    String HttpUrl = "https://orapune.com/API_TEST/event/ViewImage.php";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.admineventlayout, container, false);
        Title = new ArrayList<>();
        Data = new ArrayList<>();
        ...
        recyclerView = view.findViewById(R.id.Evrecycle);
        recyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));
        recyclerView.setHasFixedSize(true);
        viewEvent(classes, division);
    ...
    public void viewEvent(final String Student_class, final String Student_div) {
...
//            imageView.setImageBitmap(b);
        ...
        protected List<Bitmap> doInBackground(String... params) {
            ...
            for (int i = 0; i < ImageSplit.size(); i++) {
                String add = "https://orapune.com/API_TEST/event/images/" + ImageSplit.get(i);
                URL url = null;
                Bitmap image = null;
                try {
                    url = new URL(add);
