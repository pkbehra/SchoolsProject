...
import centriotech.schoolmanagment.Adapter.AdminViewHomeWorkAdapter;
...
public class AdminFeedBack extends Fragment {
    ...
    String HttpUrl="https://orapune.com/API_TEST/Feedback/ViewFeedback.php";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.adminviewfeedbacklayout, container, false);
        ...
        if (sharedPreferenceConfig.getGR("GR")==null){
            viewFeedback(classes,division,"asd");

        }else{
            viewFeedback("ty","ty",sharedPreferenceConfig.getGR("GR"));
        }

        recyclerView = view.findViewById(R.id.feed_recycle);
    ...
    public void viewFeedback(final String Student_class, final String Student_div, final String GRNO){
...
//            imageView.setImageBitmap(b);
        ...
        protected List<Bitmap> doInBackground(String... params) {
            ...
            for (int i=0;i<ImageSplit.size();i++){
                String add = "https://orapune.com/API_TEST/Feedback/images/"+ImageSplit.get(i);
                URL url = null;
                Bitmap image = null;
                try {
                    url = new URL(add);
