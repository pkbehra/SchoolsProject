...
public class Addannouncement extends Fragment {
    ...
    private String url = " https://orapune.com/API_TEST/Announcement/announcement.php";
    Button send;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        imageView = view.findViewById(R.id.announce_camera);
        btn_submit = view.findViewById(R.id.announce_submit);
        et_post = view.findViewById(R.id.announce_homework);
        ...
        mStringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String result) {
                ...
                if (result.trim().equals("data inserted")) {
                    ...
                    Toast.makeText(getActivity(), "Announcement Send Successful", Toast.LENGTH_SHORT).show();
