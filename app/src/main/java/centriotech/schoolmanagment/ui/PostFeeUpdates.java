...
public class PostFeeUpdates extends Fragment {
    ...
    private String url = "https://orapune.com/API_TEST/Fees/postfees.php";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view=inflater.inflate(R.layout.postfeeupdateslayout,container,false);

        imageView=view.findViewById(R.id.postfee_camera);
        btn_submit=view.findViewById(R.id.postfee_submit);
        et_post=view.findViewById(R.id.postfee_homework);
        et_gr=view.findViewById(R.id.postfee_grNo);
    ...
    public void UploadImageToServer() {
        ...
        addFeesUpdates(classes,division,ConvertImage,et_post.getText().toString(),et_gr.getText().toString());


    }


    public void addFeesUpdates(final String Classes, final String Div, final String Image, final String MessageS,final String GrNo) {
            ...
            public void onResponse(String result) {
                if (result.trim().equals("data inserted")) {
                  ...
                  startActivity(intent);
                    ...
                    Toast.makeText(getActivity(), "Post Fees Successful", Toast.LENGTH_SHORT).show();
